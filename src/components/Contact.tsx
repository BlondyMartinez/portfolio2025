  ...
  return (
    <section id="contact" className="py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-8">{t('contact.title')}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-[var(--card-bg)] text-[var(--text-primary)]"
                />
              </div>
          ...
          <div className="bg-[var(--card-bg)] p-6 rounded-lg shadow">
            <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-4">{t('contact.social.title')}</h3>

...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-[#1c4c3c] to-[#0a2434]">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <input
                      ...
                      className="w-full px-4 py-2 bg-gray-700/50 border border-gray-600 rounded-lg focus:outline-none focus:border-blue-400 text-white placeholder-gray-400"
                    />
                  </div>
                  <div>
                    <input
                  ...
                  <button
                    type="submit"
                    className="w-full bg-blue-400/10 text-blue-400 px-6 py-3 rounded-lg hover:bg-blue-400/20 transition-colors"
                  >
                    Send Message
                  </button>
